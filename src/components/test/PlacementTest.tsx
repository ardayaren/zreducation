...
import { placementQuestions, levelDescriptions } from "@/data/placementQuestions";
      ...
      return (
        ...
        <div className="bg-white border border-border p-8 md:p-10">
          ...
          <p className="text-slate text-sm mb-8">
            Bilgilerinizi girin ve 30 soruluk seviye tespit sınavına başlayın.
          </p>
          ...
          <p className="text-xs text-slate-light mt-6 border-t border-border pt-4">
            Sınav yaklaşık 20–25 dakika sürer. Tüm soruların cevaplanması
            gerekmektedir.
          </p>
        </div>
      </div>
  ...
  if (step === "test") {
    return (
      <div className="max-w-3xl mx-auto">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <span className="label-caps text-gold-600 block mb-4">
              Seviye {question.difficulty}
            </span>
            <h2 className="font-heading-normal text-lg md:text-xl font-bold text-navy-900 mb-8 leading-snug">
              {question.question}
            </h2>
              ...
              {question.options.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`text-sm ${
                        isSelected ? "text-navy-900 font-medium" : "text-navy-700"
                      }`}
                    >
                      {option.text}
                    </span>
        ...
        <div className="flex flex-wrap gap-1 mt-6 border-t border-border pt-6">
