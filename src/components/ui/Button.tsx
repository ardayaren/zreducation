...
const variants = {
  ...
  secondary:
    "bg-gradient-to-br from-navy-800 to-navy-900 text-white hover:from-navy-700 hover:to-navy-800 border border-transparent shadow-[0_4px_20px_rgba(14,34,64,0.18)] hover:shadow-[0_8px_28px_rgba(14,34,64,0.24)] hover:-translate-y-0.5",
  outline:
